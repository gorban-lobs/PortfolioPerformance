...
class Portfolio:
    ...
    def _calc_weighted_returns(
        ...
        If column names in current dataframe and weights dataframe
        are not equal return empty series
    ...
    def calculate_currency_performance(
        ...
        cur_returns_by_index = self._convert_names_to_ids(
                                                        currency_returns,
                                                        self.current_weights,
                                                        self.currencies)
        weighted_returns = self._calc_weighted_returns(
                                                       cur_returns_by_index,
                                                       self.current_weights)
        return self._calc_performance(weighted_returns, start_date)
